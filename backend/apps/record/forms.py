...
class RecordEventForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):  #При создании формы отображаются забронированные даты из БД и устанавливается формат
